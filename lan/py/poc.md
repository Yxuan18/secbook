...
\
什么是POC？根据名词解释阐述一下，然后再简述一下写脚本需要用到的python库以及方法，以及如何优化POC<br>
...
![某网站疑似SQL注入](<../../.gitbook/assets/image (513).png>)
...
![对应的特征：查询了1的MD5值](<../../.gitbook/assets/image (484).png>)
...
1、那么，为什么在上面文件上传的示例代码中没有定义请求头中的`content-type`字段呢？

> 因为在发送请求时，requests库会自动添加上头部的内容。

2、对于分段发送的请求内容，面对比较庞杂的数据包，应该如何最小化脚本数据包？
