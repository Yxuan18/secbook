...
* 容器内进程具有哪些权限（capabilities）？\
  Docker上执行\
  `grep CapEff /proc/self/status` 获得权限值

其他系统上执行\
`capsh --decode=value`

* 当前容器是否运行在特权模式？\
  0000003fffffffff为特权模式值
* 容器挂载了哪些卷？\
  `cat /proc/mounts`
...
> find / -name “docker-compose._“_\
> _cat /home/_/.docker/config.json
...
[云原生环境渗透工具考察](https://wohin.me/yun-yuan-sheng-huan-jing-shen-tou-xiang-guan-gong-ju-kao-cha/%E3%80%91)
