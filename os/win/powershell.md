...
![寻找powershell](<../../.gitbook/assets/image (573).png>)

powershell的两种界面：

![左：powershell，右：ISE](<../../.gitbook/assets/image (918).png>)
...
![的3个主要区域及控制它们的工具栏](<../../.gitbook/assets/image (776).png>)
...
![查看一个命令的帮助](<../../.gitbook/assets/image (470).png>)
