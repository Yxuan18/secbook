...
### 3、nmap实战 <a href="#h2-3" id="h2-3"></a>
...
### 4、nmap中文说明文档 <a href="#h2-4" id="h2-4"></a>
...
#### 扫描漏洞 <a href="#h3-1" id="h3-1"></a>

#### nmap --script=vuln ip <a href="#h3-2" id="h3-2"></a>
...
| 功能                     | 参数                                                                                                                               |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| 一次扫描多个主机（多主机探测没有，-sP）  | <p>- -min-hostgroup&#x3C;主机个数>,<br>- -max-hostgroup&#x3C;主机个数></p>                                                               |
| 一次开多个并行扫描              | <p>- -min-parallelism&#x3C;并行个数>，<br>- -max–parellelism&#x3C;并行个数></p>                                                           |
| 主机在线和重传等待              | <p>- -min-rtt-timeout&#x3C;毫秒速>,<br>- -max-rtt-timeout&#x3C;毫秒速>，<br>- -initial-rtt-timeout&#x3C;毫秒速>（可以使用单位s,m.h；多个端口累计无响应）</p> |
| 直接控制发包速度               | <p>- -min-rate&#x3C;每秒的发包次数>，<br>- -max-rate&#x3C;每秒的发包次数></p>                                                                   |
| 不关心服务端的rst包，不关心close类型 | - -defeat-rst-ratelimit                                                                                                          |
| 最大重传次数                 | - -max-retries<最大重传次数>                                                                                                           |
| 每个主机最大的耗时              | - -host-timeout<毫秒数>（可以使用单位s.m,h）                                                                                                |
| 主机每个请求的间隔时间            | <p>- -scan-delay&#x3C;毫秒数>，<br>–max-scan-delay&#x3C;毫秒数>（可以使用单位s.m,h）</p>                                                        |
